...
class ActorEvents_0 extends ActorScript
{
	...
	override public function init()
	{
		...
		/* ========================= Type & Type ========================== */
		addSceneCollisionListener(getActorType(0).ID, getActorType(5).ID, function(event:Collision, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
		...
		addCollisionListener(actor, function(event:Collision, list:Array<Dynamic>):Void
		{
			...
			{
				actor.shout("_customEvent_" + "PlayerHit");
			}
		});
